...
async function runBenchmarkCase(inputCase, input, memory) {
    ...
    if (workflow.pairing_result.ready_for_codex && workflow.pairing_result.execution_level !== "blocked") {
        guardrails = (await generateGuardrails({
...
async function securityWarningsFor(inputCase, workflow, memory, guardrails) {
