...
zhFeatureHints.push("添加", "新增", "创建", "生成", "实现", "支持", "修复", "优化", "重构", "更新", "检查", "审查", "扫描", "保存", "上传", "安装", "启用", "解析", "迁移", "替换", "换成", "进入", "完善", "方案", "指导", "排查", "注册", "打包", "发布", "部署", "文档", "说明", "任务包", "报告", "测试计划", "回归");
zhConstraintHints.push("不要", "别", "不再", "不许", "不能", "不用", "不得", "禁止", "避免", "只允许", "只做", "只改", "只能", "必须", "务必", "一定要", "保留", "不要改", "不要修改", "不要提交", "不要上传", "不要继续", "不要缩减", "先不要", "先不用", "除非", "等待我说", "等我说", "不要公开", "不要暴露", "不要泄露", "避免抄袭", "防止抄袭", "范围内", "不能加", "不要加", "不大改");
zhPreferenceHints.push("偏好", "风格", "简单", "简洁", "清晰", "一致", "紧凑", "可读", "用中文", "用英文", "中文描述", "英文", "一步步", "先给方案", "不要太详细", "避免暴露", "保密", "说明", "推荐", "建议", "适合", "优先", "最好", "真实", "稳定");
zhAcceptanceHints.push("验收", "验证", "校验", "检查", "审查", "执行后", "测试", "回归测试", "运行", "通过", "完成后", "最后", "输出", "告诉我", "逐项打勾", "结论", "结果", "编译", "构建", "跑一遍", "确认", "列出", "总结", "报告", "对照", "验收成果", "通过率");
zhPlanOnlyHints.push("先给方案", "只给方案", "先不用改", "先不要改", "不用改代码", "不要改代码", "不要改功能代码", "不改代码", "先不用提交", "只分析", "只排查", "只做诊断", "先排查", "先检查", "先看原因", "先定位原因", "先不用再改");
zhReviewOnlyHints.push("最终检查", "最终验收", "交付检查", "审查结果", "检查是否", "检查隐私数据", "风险结论", "给风险结论", "不要继续新增", "不要大改", "只做验收", "只做最终检查", "验收阶段");
zhImplementationHints.push("开始优化", "开始开发", "直接实现", "帮我修复", "修复", "生成代码", "写完整代码", "提交并推送", "上传到 GitHub", "开始改", "修改", "只改", "构建", "打包", "运行 npm run build");
zhPrivacyHints.push("不要公开", "不要暴露", "避免别人抄袭", "避免抄袭", "保密", "不要泄露", "不要把能力具体说出去", "不要把所有内部能力", "内部能力具体说出去", "不要说出去", "照着抄");
