...
import type { RequirementStrand, Priority } from "../types/requirementStrand.js";
...
export interface ParseRequirementOutput {
...
export async function parseRequirement(
  input: ParseRequirementInput,
  memoryStore: MemoryStore
): Promise<ParseRequirementOutput> {
  ...
  const requirement: RequirementStrand = {
...
function extractByHints(sentences: string[], hints: string[], includeContinuation = false): string[] {
...
function enrichWithStructuredDirectives(
  request: string,
  features: string[],
  constraints: string[],
  preferences: string[],
...
function priority(request: string, constraints: string[]): Priority {
...
function defaultAcceptance(features: string[], constraints: string[]): string[] {
...
function goalScore(sentence: string, index: number): number {
...
function hasTargetSignal(request: string): boolean {
...
function isDocumentationOnlyRequest(request: string): boolean {
