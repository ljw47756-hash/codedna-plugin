export async function updateMemory(input, memoryStore) {
    const memory = await memoryStore.updateMemory(input.memory_patch ?? {}, input.event, input.successful_pattern, input.rejected_pattern);
